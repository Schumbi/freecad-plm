...
urlpatterns = [
    ...
    path(
        "print-projects/<int:print_project_id>/download/",
    ...
    path("print-projects/<int:print_project_id>/assign/", views.reassign_print_project_view, name="reassign_print_project"),
    ...
    path("api/print-project-plates/<int:plate_id>/preview/", api.print_project_plate_preview_api, name="api_print_project_plate_preview"),
    ...
    path(
        "api/checkouts/<int:checkout_id>/files/add/",
        api.checkout_add_file_api,
        name="api_checkout_add_file",
    ),
    path(
